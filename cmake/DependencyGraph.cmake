...
if (DOT_EXE)
    ...
    set(BUILD_DEPENDENCY_GRAPH OFF)
endif ()
...
function(gen_dep_graph OUTPUT_TYPE)
    ...
    if (BUILD_DEPENDENCY_GRAPH)
        ...
        else (gen_dep_graph_TARGET_NAME)
            set(TARGET_NAME dep-graph-${PROJECT_NAME})
        endif (gen_dep_graph_TARGET_NAME)

        if (gen_dep_graph_OUTPUT_DIR)
            set(OUT_DIR ${gen_dep_graph_OUTPUT_DIR})
        else (gen_dep_graph_OUTPUT_DIR)
            set(OUT_DIR ${CMAKE_CURRENT_BINARY_DIR})
        endif (gen_dep_graph_OUTPUT_DIR)
        ...
        if (gen_dep_graph_ADD_TO_DEP_GRAPH)
            ...
            endif (NOT TARGET dep-graph)

            add_dependencies(dep-graph ${TARGET_NAME})
        endif (gen_dep_graph_ADD_TO_DEP_GRAPH)
    endif (BUILD_DEPENDENCY_GRAPH)
endfunction()