...
{
    /**!
     * A heuristic for calculating the manhattan distance between a grid cell and the goal grid cell
     *
    ...
    class GridCellManhattanDistance : public HeuristicBase<GridCellDerive>
    {
       public:
        /**!
         * Constructor
         ...
         */
        explicit GridCellManhattanDistance(const std::shared_ptr<const GridCell>& goal)
            : m_goal(goal)
        {}
        ...
        {
            return cell->manhattanDistance(*m_goal);
        }
