...
namespace grstapse
{
    ...
    /**
     * Creates the children of a GridCellNode as the GridCells in the eight adjacent directions
     */
    class GridCellAdjacentGenerator : public SuccessorGeneratorBase<GridCellNode>
    {
        using Base = SuccessorGeneratorBase<GridCellNode>;

       public:
        //! \brief Constructor
        explicit GridCellAdjacentGenerator(const std::shared_ptr<const GridMap>& map);
