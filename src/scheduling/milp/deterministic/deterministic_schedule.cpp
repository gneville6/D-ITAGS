...
namespace grstapse {
    DeterministicSchedule::DeterministicSchedule(
            ...
            : ScheduleBase(makespan, precedence_set_mutex_constraints), m_timepoints(timepoints) {}

    DeterministicSchedule::DeterministicSchedule(DeterministicSchedule const &toCopy) {
        m_makespan = toCopy.m_makespan;
        m_timepoints = toCopy.m_timepoints;
